...
import { UsersIcon, CalendarIcon, TicketIcon } from '@/components/icons';
...
const FEATURES = [
  {
    ...
    description:
      'Manage club memberships, communications, and resources efficiently.',
  },
  {
    ...
    description:
      'Plan and promote events with ease, from scheduling to logistics.',
  },
  {
    id: 'qr-ticketing',
    icon: <TicketIcon />,
    title: 'QR Ticketing',
    description:
      'Generate and manage QR tickets for secure and hassle-free event access.',
  },
];

export default function Home() {
  const handleJoinStudent = () => {
    console.log('Join as Student clicked');
  ...
  return (
    <MainLayout>
      <HeroSection
        ...
        onPrimaryClick={handleJoinStudent}
        onSecondaryClick={handleExploreFeatures}
      />
